...
with DAG('etl_usecase123', schedule_interval="@once", default_args=default_args, catchup=False) as dag:
    ...
    task_process_etl_usecase2 = BashOperator(
        ...
        bash_command='python /opt/airflow/dags/script/etl_usecase2.py'
    )
    task_process_etl_usecase3 = BashOperator(
        task_id='task_process_etl_usecase3',
        bash_command='python /opt/airflow/dags/script/etl_usecase3.py'
    )
